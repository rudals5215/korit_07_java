...
//        System.out.println('안녕하세요, 제이름은 이경민 입니다'); // 오류 발생
        ...
        /*
            ...
            하드코딩이라는 표현을 씁니다.
            하드코딩 : 명령문에 데이터(변수에 대입되지 않은 데이터인데
            이를 리터럴(Literal))를 바로 집어넣는 것으로, '지양'되는 방식.

            그렇다면 권장되는 방식은 ? 데이터를 '변수'에 대입하고 변수를 통해서
                명령을 내리는 방식
        ...
        /*
            ...
            떄문에 원하는 방식으로 출력되지 않습니다 144어쩌거로 출력됐죠.
            ...
            라고 알아두면 되겠습니다(근데 python이랑 JavaScript에서는 또 이런 구분이
            없습니다.)
...
//        int pi = 3.14;        // 오류 발생
        ...
        /*
            제가 위에 선언한 변수들에 여러분드,ㄹ에게 적합한 데이터로 '초기화'하여
            '저는 코리아 it 아카데미 7월 극바과정을 수강하고 있는 누구누구 입니다. ?? 살입니다. -> 줄바꿈
            제 전공은 어쩌고저쩌고학과이며, mbti는 블라블라입니다. 열심히할게요!!!!'
            와 같이 출력 될 수 있도록 sout을 작성하시오
         */
