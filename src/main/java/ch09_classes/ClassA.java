...
/*
    ...
    2. 객체(object)란?
        클래스를 설계도로 가정했을 때, 실제 사용할 수있는 자동차(인스턴스)는 객체라고 함.

        여기서 object와 Instnace라는 표현은 우리나라에서는 거의 동일합니다.
...
public class ClassA {
    ...
    // 밑에 뭔가 변수들을 선언만 했다는것을 확인 할 수 잇습니다.
    int num;
    String name;
    double score;
