...
public class Tiger extends Animal{  // 자식클래스 extends 부모클래스
    ...
    public void hunt(String prey){
        System.out.println(getAnimalName() + "이(가) "+ prey +"를 사냥을 합니다.");
    }
    // 재정의 됨 method : 부모 메서드의 결과값과 다르게 작성 한다면 전부 재정의에 해당함.
    ...
    @Override       // 이 경우는 method명만 동일하고 전부 다 재정의 했습니다.
    public void move() {
