...
public class Person {
    ...
    /*
        PersonMain 에서 생성자 호출을 통해서 객체를 생성하는 것을 막았습니다.
        그리고 매개변수 부분을 보면 Builder builder 라고 되어있고,
        그 다음 줄에는 builder.name을 봤을 때,
        builder 객체의 필드로 name / age / address 가 있는 것으로 보입니다.
    ...
    public static class Builder{
        ...
        /*
            ...
            대부분의 경우 method는 행위를 나타내기 때문ㄴ에 동사로 시작한다고
            설명했지만, Builder 패턴의 경우
            대입될 필드의 이름과 동일한 메서드 명을 짓습니다.
            근데 필드는 명사로 지으니까 명사겠네요.
         */
        public Builder name(String name){
            this.name = name;   // 객체가 생성되면 객체 이름으로 치환되는 키워드
            return this;        // 여태까지는 name에 값이 없다가, 38번 코드라인 시점에 name field에
            // 값이 대입된 객체가 리턴됨.
        }
        ...
        public Person build(){
            return new Person(this);        // 이 this 는 Builder 클래스의 인스턴스에 해당합니다.
        }
    }
}
