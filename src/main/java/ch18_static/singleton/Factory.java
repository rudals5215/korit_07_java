...
public class Factory {
    ...
    public SmartPhone produceSmartPhone(){
        System.out.println(factoryName + "에서 스마트폰을 생산힙니다.");
        // 접근지정자 안썼으니까 default입니다. 그리고 {} 영역 내에 있으니까 지역변수네요.
        String model = "갤럭시s26";
        String serial;
        ...
        // 지금 현재 리턴 타입이 SmartPhone 입니다. 그러니까 SmartPhone 객체가 튀어나와야 하는데.
        // 스마트폰 객체 생성할 때 저희 뭐해야 하냐면
