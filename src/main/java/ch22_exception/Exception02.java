...
//            System.out.println("ID 혹은 비밀번호를 확인하세요.");
            throw new LoginFailedException("ID 혹은 PW가 틀렸습니다.");
            // "ID 혹은 PW가 틀렸습니다."를 argument로 하는 LoginFailedException 객체가 생성되었다고 할 수 있겠네요
        }
    }
...
//        login(inputId,inputPassword);   // 코드 작성 순서를 잘 기억하시면 좋겠습니다.
        ...
        try{
            ...
            // 이상을 실행했을 때 e.getMessage()의 결과값이 "ID 또는 PW가 틀렸습니다."라는 것을 확인할 수 있습니다.
        } finally {
...
/*
    ...
    배워온 코드 작성 방법과 차이가 없단느 것을 확인할 수 있습니다.
 */