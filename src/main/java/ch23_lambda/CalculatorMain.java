...
public class CalculatorMain {
    ...
    public static void main(String[] args) {
        ...
        // 근데 인터페이스 내부에는 두 개의 매개변수만 정의되어 있었습니다.
        // 저희는 여기서 추가 조작을 통해서 사칙연산을 시도할 겁니다.
...
//        System.out.println(add(2,3));                     // 오류 발생
        ...
        System.out.println("2 + 3 = " + operate(2,3,add));      // static method의 로직을 보시면,
        // 세번째 매개변수로 Calculator 인터페이스의 서브 클래스를 받습니다.
        // 그리고 return 문을 보시면 해당 객체의 .calculate() 메서드를 호춣하는 것을 확인할 수 있습니다.
        // 근데 add.calculate()는 return이 x+y니까, 결과값이 5가 나왔겠네요.
        // 그러면 우리는 24번 코드라인의 해석을 위해서
